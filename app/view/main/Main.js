				...
				,items: [
					{
						...
						,tooltip: locale['app.main[17]']+'<br/><b>'+locale['app.main[18]']+(process.platform === 'darwin' ? ': Cmd + Alt + D</b>' : ': Alt + Shift + D</b>')
						,enableToggle: true
						,handler: 'dontDisturb'
					...
					,{
						...
						,tooltip: locale['app.main[20]']+'<br/><b>'+locale['app.main[18]']+(process.platform === 'darwin' ? ': Cmd + Alt + L</b>' : ': Alt + Shift + L</b>')
						,handler: 'lockRedil'
						,id: 'lockRedilBtn'
					}
					,'->'
