// Vendored from github.com/ramboxapp/electron-contextmenu-wrapper, whose upstream
// is archived. Only change: the built-in `remote` module was removed in Electron 14,
// so this pulls the same API from @electron/remote instead.
